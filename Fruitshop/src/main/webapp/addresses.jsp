            ...
            <aside class="profile-sidebar">
                <div class="profile-user-brief">
                    ...
                    <div class="brief-info">
                        <span class="brief-name"><c:out value="${sessionScope.account.fullName}"/></span>
                    ...
                    <c:forEach var="addr" items="${addresses}">
                        <div class="address-card <c:if test='${addr.defaultAddress}'>default</c:if>">
                            <div class="address-info">
                                <div class="info-row">
                                    <span class="info-name"><c:out value="${addr.receiverName}"/></span>
                                    <span class="info-divider">|</span>
                                    <span class="info-phone"><c:out value="${addr.phoneNumber}"/></span>
                                </div>
                                <div class="info-address">
                                    <p><c:out value="${addr.address}"/></p>
                                    <p><c:out value="${addr.city}"/></p>
                                </div>
                                <div class="info-tags">
