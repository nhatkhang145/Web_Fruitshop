        ...
        <section class="stats-grid stats-grid--kpi">
            <article class="stat-card accent-teal">
                ...
                <div>
                    ...
                    <strong><fmt:formatNumber value="${totalImportValue != null ? totalImportValue : 0}" type="number" groupingUsed="true"/> VND</strong>
            ...
            <article class="stat-card accent-gold">
                ...
                <div>
                    ...
                    <strong><fmt:formatNumber value="${totalRevenue != null ? totalRevenue : 0}" type="number" groupingUsed="true"/> VND</strong>
            ...
            <article class="stat-card accent-green">
                ...
                <div>
                    ...
                    <strong><fmt:formatNumber value="${totalCogs != null ? totalCogs : 0}" type="number" groupingUsed="true"/> VND</strong>
            ...
            <article class="stat-card accent-rose">
                ...
                <div>
                    ...
                    <strong><fmt:formatNumber value="${totalWasteCost != null ? totalWasteCost : 0}" type="number" groupingUsed="true"/> VND</strong>
            ...
            <article class="stat-card accent-slate">
                ...
                <div>
                    ...
                    <strong><fmt:formatNumber value="${totalProfit != null ? totalProfit : 0}" type="number" groupingUsed="true"/> VND</strong>
            ...
            <article class="stat-card accent-citrus">
                ...
                <div>
                    ...
                    <strong><fmt:formatNumber value="${totalInventoryValue != null ? totalInventoryValue : 0}" type="number" groupingUsed="true"/> VND</strong>
            ...
            <form class="filter-form" action="${pageContext.request.contextPath}/admin/dashboard" method="GET">
                ...
                <div class="filter-field">
                    ...
                    <select id="exportType" name="exportType">
                        <option value="all" ${empty currentExportType || currentExportType == 'all' ? 'selected' : ''}>Tất cả</option>
                        <option value="SALES" ${currentExportType == 'SALES' ? 'selected' : ''}>Bán hàng</option>
                        <option value="INTERNAL" ${currentExportType == 'INTERNAL' ? 'selected' : ''}>Nội bộ</option>
                        <option value="TRANSFER" ${currentExportType == 'TRANSFER' ? 'selected' : ''}>Điều chuyển</option>
                        <option value="WASTE" ${currentExportType == 'WASTE' ? 'selected' : ''}>Sản phẩm hỏng</option>
                    </select>
                </div>
                <div class="filter-actions">
                    <button type="submit" class="btn btn-primary">Áp dụng</button>
                    <a class="btn btn-ghost" href="${pageContext.request.contextPath}/admin/dashboard">Đặt lại</a>
                </div>
            </form>
        </section>
                            ...
                            <tbody>
                                <c:forEach var="item" items="${topProfitProducts}">
                                    <tr>
                                        ...
                                        <td>${item.quantity}</td>
                                        <td><fmt:formatNumber value="${item.revenue}" type="number" groupingUsed="true"/> VND</td>
                                        <td><fmt:formatNumber value="${item.cogs}" type="number" groupingUsed="true"/> VND</td>
                                        <td><span class="profit-badge positive"><fmt:formatNumber value="${item.profit}" type="number" groupingUsed="true"/> VND</span></td>
                                    </tr>
                                </c:forEach>
                                <c:if test="${empty topProfitProducts}">
                                    <tr>
                                        <td colspan="5" class="table-empty">Chưa có dữ liệu lợi nhuận cao.</td>
                                    </tr>
                                </c:if>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                <c:forEach var="item" items="${topLossProducts}">
                                    <tr>
                                        ...
                                        <td><fmt:formatNumber value="${item.revenue}" type="number" groupingUsed="true"/> VND</td>
                                        <td><fmt:formatNumber value="${item.cogs}" type="number" groupingUsed="true"/> VND</td>
                                        <td><span class="profit-badge negative"><fmt:formatNumber value="${item.profit}" type="number" groupingUsed="true"/> VND</span></td>
                                    </tr>
                                </c:forEach>
                                <c:if test="${empty topLossProducts}">
                                    <tr>
                                        <td colspan="5" class="table-empty">Chưa có dữ liệu lợi nhuận thấp.</td>
                                    </tr>
                                </c:if>
                            </tbody>
                        </table>
