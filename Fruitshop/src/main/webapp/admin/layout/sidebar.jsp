...
<div class="sidebar">
    ...
    <ul class="side-menu">
        ...
        <li class="${param.activePage == 'inventory' ? 'active' : ''}">
            <a href="${pageContext.request.contextPath}/admin/inventory-management.jsp"><i class='bx bx-archive-in'></i>Quản lý nhập kho</a>
        </li>
        ...
        <li class="${param.activePage == 'reports' ? 'active' : ''}">
            <a href="${pageContext.request.contextPath}/admin/reports"><i class='bx bx-line-chart'></i>Thống kê</a>
        </li>
    </ul>
</div>
        <div class="sidebar">
