...
<head>
    ...
    <title>Tạo phiếu nhập kho | Admin</title>
...
<div class="content">
    ...
    <main class="receipt-create-page">
        <section class="receipt-hero">
            <div class="hero-copy">
                <a class="back-link" href="${pageContext.request.contextPath}/admin/inventory-management">
                    <i class='bx bx-arrow-back'></i>
                    Quay lại danh sách phiếu
                </a>
                
                <h1>Phiếu nhập kho mới</h1>
            </div>
        </section>
                    ...
                    <div class="receipt-main">
                        <div class="card card-glow">
                            ...
                            <div class="form-grid form-grid--2">
                                <div class="form-group">
                                    <label for="inputSupplierSelect">Chọn nhà cung cấp <span class="required">*</span></label>
                                ...
                                <div class="form-group">
                                    <label for="inputSupplierName">Hoặc nhập nhà cung cấp mới</label>
                            ...
                            <p class="field-hint">Chọn nhà cung cấp có sẵn hoặc nhập tên mới để thêm ngay trong phiếu.</p>
...
<script src="${pageContext.request.contextPath}/assets/js/admin/inventory-receipt-create.js"></script>
</body>
</html>
