                            ...
                            <div class="address-modal" id="addressModal">
                                ...
                                <div class="modal-container">
                                    ...
                                    <div class="modal-body">
                                        <c:forEach var="addr" items="${addresses}">
                                            <div class="address-option" data-id="${addr.id}" data-name="${addr.receiverName}"
                                                 data-phone="${addr.phoneNumber}" data-address="${addr.address}, ${addr.city}"
                                                ...
                                                <div class="radio-wrapper">
                                                    <input type="radio" name="selectedAddr" value="${addr.id}" ${addr.defaultAddress
                                                            ? 'checked' : '' }>
                                                </div>
                                            </div>
                                        </c:forEach>
